...
; NOAA 11161 OF 2011/2/19 AT 3 DIFFERENT ATMOSPHERIC HEIGHTS 
; 0:0:0_TAI to 12:0:0_TAI
; OBS_VR varies between +2921.51 m/s and -2194.97 m/s
...
SAVE,vel,caltot32,caltot41,caltot50,FILE='NOAA11161_caltot.bin'
...
SAVE,ratio,vtest,file='lookup_NOAA11161.bin'
...
; CORRECTION SO THAT THE CURVES
; plot,vel,total(reform(d[256,175:215,*]),1)/41. SUPERIMPOSES WITH oplot,[-5000,5000],[-5000,5000]
; as measured by minimizing: total(abs(total(reform(d[256,175:215,*]),1)/41.-vel))
; for all three velocities

;Doppler50 = Doppler50+95.5

writefits, 'Doppler50_NOAA11161.fits',Doppler50
writefits, 'Doppler41_NOAA11161.fits',Doppler41
writefits, 'Doppler32_NOAA11161.fits',Doppler32
writefits,'magnetic50_NOAA11161.fits',magnetic50
writefits,'magnetic41_NOAA11161.fits',magnetic41
writefits,'magnetic32_NOAA11161.fits',magnetic32
