...
xtitle=xtitle, ytitle=ytitle,xrange=xrange,yrange=yrange,title=title,help=help,print=print
;+
...
if keyword_set(print) then begin
    SET_PLOT,'PS'
    DEVICE,file='yo.ps',xoffset=0,yoffset=0,xsize=20,ysize=14
endif
...
;
  ...
  ytitle=ytitle, xrange=xrange,yrange=yrange, xtitle=xtitle,title=title,charsize=1.5,xst=1,thick=2
endif else begin
;
; overplot
;
...
;SAVE,ifin,bin,mini,hist,file='temp5.bin'
