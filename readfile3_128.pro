...
FUNCTION readfile3_128,header,nx,ny,base,list,nlam
...
SET_PLOT,'x'
n      = 12 ; numbers of filtergrams: the 1st and last ones are just dark current
nkey   = 91
header = STRARR((n-2)*nlam,nkey)

imx    = FLTARR(nx,ny,nlam*(n-2))
name   = 'qqq'
...
SAVE,imx,header,FILE='TMPREADFILE3_060210_FIV_32.BIN'
